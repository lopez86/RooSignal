#include "ContinuousFilter.h"
#include <algorithm>

void
signal::ContinuousFilter::Smooth(const Int_t inputsize, const Double_t input[],
...
void 
signal::ContinuousFilter::Smooth(const std::vector<Double_t>& input, 
